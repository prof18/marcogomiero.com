...
On GitHub, I’ve published [a sample project](https://github.com/prof18/kmp-xcframework-sample) to showcase the usage of the task. In the [main](https://github.com/prof18/kmp-xcframework-sample) branch the tasks are manually added in the [build.gradle.kts](https://github.com/prof18/kmp-xcframework-sample/tree/with-plugin) file. In the [with-plugin](https://github.com/prof18/kmp-xcframework-sample/tree/with-plugin) branch instead, the KMP FatFramework Cocoa plugin is used. 
