...
summary: In this talk, we will see how it's possible to create a mobile application for Android and iOS that share some code (for example business logic, network, etc.) using Kotlin Multiplatform. We will show a real application that we have built for this talk, i.e. a showcase app for the GDG Venezia.<br><br>We will show also how it's possible to create a backend for this app by of course using Kotlin!
---
